...
تم تنفيذ المرحلة الأولى من التحكم التشغيلي: اختيار مرشح TMDB يدويًا، إعدادات التحديث التلقائي، Queue بخيارات الأولوية والإلغاء وإعادة المحاولة، وعامل خلفي محدود التزامن، وتقارير استهلاك يومية.
