...
export default function SmartHubCard({ hub, onOpen }) {
  ...
  return <button type="button" onClick={() => onOpen?.(hub)} className="luminous-card group relative min-h-[204px] w-full overflow-hidden rounded-2xl bg-[#0E0C1A] text-right focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)]" dir="rtl">
